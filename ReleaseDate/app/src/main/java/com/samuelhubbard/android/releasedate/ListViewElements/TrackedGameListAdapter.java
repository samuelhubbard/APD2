...
public class TrackedGameListAdapter extends BaseAdapter {


    // creating the ID constant
    private static final int ID_CONSTANT = 0x10101011;

    // member variables
    private Context mContext;
    private ArrayList<GameObject> mGames;

    // the adapter constructor
    public TrackedGameListAdapter(Context c, ArrayList<GameObject> games) {
        mContext = c;
        mGames = games;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GameObject game = (GameObject) getItem(position);
        ...
        if (game.isSectionHeader()){
            ...
            String headerText = game.getName() + " " + game.getYear();
